    ...
    <div>
      ...
      <div className='grid grid-cols-3 gap-5 items-center justify-center p-14 leading-loose bg-white '>
        ...
        <div className='bg-[white] border-green-300 border-4 md:rounded-lg  p-4'>
          ...
          <p className='pt-3'> Postiize simplifies advertising for businesses with intuitive tools and precise targeting. We provide real-time analytics to maximize your ad’s impact. Boost your brand’s visibility with ads that deliver results.</p>
        </div>
